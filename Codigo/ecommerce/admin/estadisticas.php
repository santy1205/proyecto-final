          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">Diseña un tema agradable</span>
                    <!-- Emphasis label -->
                  ...
                  <li>
                    ...
                    <span class="text">Haz que el tema sea responsive</span>
              ...
              <div class="card-footer clearfix">
                <button type="button" class="btn btn-info float-right"><i class="fas fa-plus"></i> Agregar un item</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white">Email ordenes</div>
                  </div>
                  <!-- ./col -->
                  <div class="col-4 text-center">
